package com.boomer.alphaassault.graphics.graphicsutils;

import com.badlogic.gdx.graphics.Texture;
import com.badlogic.gdx.graphics.g2d.TextureRegion;

/**
 * Created by Omer on 12/16/2015.
 */
public class TextureSplitter {
    public static TextureRegion[][] split(Texture _texture, int _x, int _y, int _width, int _height,int _xNumber,int _yNumber){
